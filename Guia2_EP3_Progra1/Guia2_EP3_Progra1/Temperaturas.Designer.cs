...
namespace Guia2_EP3_Progra1
{
	partial class Temperaturas
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Ingresa la temperatura:";
			...
			this.label3.Text = "Presiona el botón adecuado";
			// 
			// label4
			// 
			...
			this.label4.Text = "F a C convierte de grados Farenheit a grados Centigrados";
			...
			this.label5.Text = "C a F convierte grados Centigrados a grados Farenheit";
			// 
			// button3
			// 
			...
			this.button4.Location = new System.Drawing.Point(183, 241);
